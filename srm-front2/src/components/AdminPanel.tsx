...
import { Plus, Trash2, Mail, User, Lock, AlertCircle, Check } from 'react-feather';
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            {showCreateForm && (
              <form onSubmit={handleCreateEditor} className="space-y-4 bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                {editors.map((editor) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center px-4 py-2 bg-red-50 text-red-600 border border-red-200 rounded-lg hover:bg-red-100 transition-colors font-medium disabled:opacity-70"
                    >
