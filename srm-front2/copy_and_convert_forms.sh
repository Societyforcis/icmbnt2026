...
mkdir -p public/docs
cp -f public/docs/ICMBNT_2026_Registration_Form.html public/docs/ICMBNT_2026_Registration_Form.html.bak
cp -f public/docs/ICMBNT_2026_Copyright_Form.html public/docs/ICMBNT_2026_Copyright_Form.html.bak

# Copy HTML files to public/images
mkdir -p public/images
cp -f public/docs/ICMBNT_2026_Registration_Form.html public/images/
cp -f public/docs/ICMBNT_2026_Copyright_Form.html public/images/
...
echo "- public/images/ICMBNT_2026_Registration_Form.pdf"
echo "- public/images/ICMBNT_2026_Copyright_Form.pdf"
echo ""
